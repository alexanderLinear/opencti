...
import { ImportFilesUploader_connectors$data } from './__generated__/ImportFilesUploader_connectors.graphql';
import type { Theme } from '../../../../../components/Theme';

interface ImportFilesListProps {
  files: FileWithConnectors[];
  connectorsForImport: ImportFilesUploader_connectors$data['connectorsForImport'];
